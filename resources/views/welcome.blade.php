...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/themes/blue/pace-theme-loading-bar.css" integrity="sha256-C04FkCM4IIPoy89qyN2FpvJBPLsjcur6jd0bQriROUc=" crossorigin="anonymous" />
    </head>
    <body>
